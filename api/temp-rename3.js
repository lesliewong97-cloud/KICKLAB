export default async function handler(req, res) {
  try {
    ...
    const requests = [
      { updateSheetProperties: { properties: { sheetId: 0, title: 'Inventory' }, fields: 'title' } },
      { updateSheetProperties: { properties: { sheetId: 1276512557, title: 'Product Upload' }, fields: 'title' } },
    ];
